...
time_func <- function(){
  ...
  time <- list(timeStamp_global, entry_time)
  return(time)
}
...
t_mb <- make_blast_db(infile = "C:\\Users\\sarah\\OneDrive\\Documents\\prot.fasta", dbtype = "prot", taxids_file = "C:\\Users\\sarah\\OneDrive\\Documents\\blastinR\\taxid_map_internalDS.txt")
m <- make_blast_db(infile = "C:\\Users\\sarah\\OneDrive\\Documents\\aaAA.fasta", dbtype = "prot")
t_mb
m
